export default function Footer() {
    return (
      <header className="flex flex-col w-full">
        {/* <div className="bg-blue-800 text-white px-6 py-4 flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="space-y-1 mb-4 md:mb-0">
            <h1 className="text-xl font-semibold">Alt 24</h1>
            <p className="text-sm text-blue-100">DJSCE, Mumbai</p>
